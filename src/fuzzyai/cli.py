...
async def run_cli() -> None:
    ...
    parser = argparse.ArgumentParser(prog="riddler", formatter_class=argparse.RawTextHelpFormatter, description="Riddler - Automatic LLM Fuzzer")
